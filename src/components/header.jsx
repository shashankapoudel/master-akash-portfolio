        ...
        <div className='flex flex-col sticky top-0 z-50 shadow-md'>
            ...
            <div className='flex justify-between items-center bg-gray-100 text-[#606060] py-1 px-4 lg:py-4 lg:px-9  mx-2 lg:mx-8'>
                ...
                <button
                    ...
                    className='border px-1  lg:px-8 py-3   text-white text-sm bg-gradient-to-r from-[#044F86] to-[#0A6EB5]    shadow-lg hover:shadow-xl transition-transform duration-300  ease-out  hover:scale-105'>
                    Book Appointment
                </button>
