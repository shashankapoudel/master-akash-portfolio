        ...
        <div className='flex flex-col gap-2 relative mt-4 p-4'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-2'>
                ...
                <div className=' flex flex-col items-center p-8 border border-[#E6E7F3] bg-[#FFFFFF] rounded-lg'>
                    ...
                    />
                    <p className='text-[#666666]'>In a world filled with distractions, finding inner peace can feel like a distant dream. Yogi Akash offers personalized meditation guidance to help you reconnect with your inner self, achieve mental clarity, and cultivate lasting tranquility.</p>
