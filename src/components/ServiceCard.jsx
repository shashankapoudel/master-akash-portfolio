        ...
        <div className='flex flex-col gap-2 relative mt-4 p-4 font-poppins'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-2'>
                ...
                <div className=' flex flex-col items-center p-4 lg:p-12 border border-[#E6E7F3] bg-[#FFFFFF] rounded-lg'>
                    ...
                    <button
                        className='w-full lg:w-1/3 bg-[#044F86] rounded-md p-2 text-white mt-2  bg-gradient-to-r from-[#044F86] to-[#0A6EB5] transition-transform duration-300  ease-out  hover:scale-105  '
                    >
                        Book my session
                    </button>
                ...
                <div className=' flex flex-col items-center p-4 lg:p-12 border border-[#E6E7F3] bg-[#FFFFFF] rounded-lg'>
                    ...
                    <button
                        className='w-full lg:w-1/3 flex items-center justify-center bg-[#044F86] rounded-md p-2 text-white mt-2  bg-gradient-to-r from-[#044F86] to-[#0A6EB5] transition-transform duration-300  ease-out  hover:scale-105 '
                    >
                        Book my session
                    </button>
                </div>
