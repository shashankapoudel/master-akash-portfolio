            ...
            <div className="flex flex-col lg:flex-row md:flex-col justify-between p-4 gap-4 shadow-lg">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center p-0 md:p-4 lg:p-8 py-4">
                    ...
                    <div className='flex items-end justify-end '>
                        <p className="flex text-center lg:text-end text-xl md:text-3xl lg:text-3xl font-bold md:font-semibold tracking-widest text-[#3c5551] font-poppins">
                            Himalayas master Akash Banjara
                        </p>
                    </div>

                    <p className="text-[#666666] font-medium lg:text-lg text-sm md:text-xl font-poppins lg:tracking-wide tracking-normal text-justify max-w-4xl py-4">
