...
//                         className="absolute top-0 left-20 flex flex-col gap-2 bg-[#A7594D] text-white p-2  shadow-md w-1/3 items-center justify-center rounded-custom-1 py-2 px-4"
//                     >
//                         <h3 className="font-bold text-lg">Meditation and Mindfulness</h3>
...
//                         className="absolute flex flex-col items-center justify-center gap-2 bg-[#A7594D] text-white p-2 rounded-custom-1 shadow-md w-1/3 py-2 px-4"
//                     >
//                         <h3 className="font-bold text-lg">Sound Healing Therapy</h3>
...
//                         className="absolute bottom-0 left-10 flex flex-col items-center justify-center gap-2 bg-[#A7594D] text-white py-2 px-4 rounded-custom-1 shadow-md w-1/3"
//                     >
//                         <h3 className="font-bold text-lg">Spiritual Events and Retreats</h3>
...
//                             alt="Sound Healing"
//                             className="w-1/3 pr-4 object-cover mix-blend-multiply"
//                         />
//                     </div>
...
//                         className="absolute top-0 right-20 items-center justify-center flex flex-col gap-2 bg-[#A7594D] text-white py-2 px-4 rounded-custom shadow-md w-1/3"
//                     >
//                         <h3 className="font-bold text-lg">Sound Baths and Relaxation</h3>
//                         <p className='flex justify-center items-center text-center'>Enjoy soothing sounds that melt away stress and bring deep relaxation.</p>
//                     </motion.div>
...
//                         className="absolute right-10 items-center justify-center flex flex-col gap-2 bg-[#A7594D] text-white p-2 rounded-custom shadow-md w-1/3 py-2 px-4"
//                     >
//                         <h3 className="font-bold text-lg">Yoga and Energy Awakening</h3>
...
//                         className="absolute bottom-0 right-16 flex flex-col items-center justify-center gap-2 bg-[#A7594D] text-white p-2 rounded-custom shadow-md w-1/3 py-2 px-4"
//                     >
...
const ServicesPage = () => {
    ...
    return (
        <div className="flex flex-col p-4 lg:p-8  tracking-normal">
            <div className="p-4 lg:p-8 items-center justify-center">
                <motion.div
                    ref={ref}
                    className="flex flex-col gap-4 lg:gap-0 items-center lg:relative font-poppins"
                ...
                >
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        <motion.div
                            ...
                            className="lg:absolute lg:top-0 lg:left-20 flex flex-col gap-2 bg-[#A7594D] text-white p-2 shadow-md  w-full lg:w-1/3 items-center justify-center rounded-custom-1-sm lg:rounded-custom-1 py-2 px-4 cursor-pointer"
                        >
                            <h3 className="font-bold text-lg text-center">Meditation and Mindfulness</h3>
                            <p className="flex items-center justify-center text-center text-sm">Calm your mind and find peace through meditation techniques.</p>
                        </motion.div>
                    </a>
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        <motion.div
                            variants={itemVariants}
                            className="lg:absolute bottom-32 left-10 flex flex-col items-center justify-center gap-2 bg-[#A7594D] text-white p-2 rounded-custom-2-sm lg:rounded-custom-2 shadow-md w-full lg:w-1/3  py-2 px-4 lg:py-2 lg:px-4"
                        >
                            <h3 className="font-bold text-lg text-center">Sound Healing Therapy</h3>
                            <p className='text-center text-sm'>Calm your mind and find peace through meditation techniques.</p>
                        </motion.div>
                    </a>
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        ...
                        >
                            <h3 className="font-bold text-lg text-center">Spiritual Events and Retreats</h3>
                            <p className='text-center text-sm'>Take a break from daily life to recharge and reconnect with yourself.</p>
                        </motion.div>
                    </a>
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        <motion.div
                            ...
                            className="lg:absolute top-0 right-20 items-center justify-center flex flex-col gap-2 bg-[#A7594D] text-white py-2 px-4  rounded-custom-4-sm lg:rounded-custom-4 shadow-md w-full lg:w-1/3"
                        >
                            <h3 className="font-bold text-lg text-center">Sound Baths and Relaxation</h3>
                            <p className='flex justify-center items-center text-center text-sm'>Enjoy soothing sounds that melt away stress and bring deep relaxation.</p>
                        </motion.div>
                    </a>
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        ...
                        >
                            <h3 className="font-bold text-lg text-center">Yoga and Energy Awakening</h3>
                    ...
                    <a href='https://www.soundhealinghk.com/soundservices' target="_blank" rel="noopener noreferrer">
                        ...
                        >
                            <h3 className="font-bold text-lg text-center">Healing & Wellness Workshops</h3>
