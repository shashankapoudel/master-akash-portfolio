...
const About = () => {
    return (
        <div className='m-2 lg:m-4 tracking-wide'>
            ...
            <div className='p-3 md:p-5 lg:p-10 flex flex-col gap-8 items-center'>
                ...
                <div className='flex flex-col items-center justify-center py-8 w-full'>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, delay: 0.2 }}
                        className='flex flex-col-reverse md:flex-col-reverse lg:flex-row gap-8 items-center w-full'
                    >
                        <div className='w-full lg:w-1/2'>
                            <p className="text-[#666666] leading-relaxed font-poppins">
            ...
            <div className='flex flex-col p-4 md:p-5 lg:p-8 gap-4 relative border-t border-b w-full'>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.2 }}
